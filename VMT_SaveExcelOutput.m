...
switch outputType
    case 'Multiple'
       ...
       log_text = {'Writing data to Excel file...';...
        ...
        sout = {dataPath};
        xlswrite(outfile,sout,'VMTSummary','I3');
        sout = dataFiles(:);
        xlswrite(outfile,sout,'VMTSummary','I4');
        sout = {...
            'VMT: SUMMARY OF MEAN CROSS SECTION' '' '' '' '' '';...
            'VMT ' V.version V.release '' '' '';...
            'Date Processed: ' datestr(now) '' '' '' '';...
            '' '' '' '' '' '';...
            'MEAN CROSS SECTION (MCS) PROPERTIES' '' '' '' '' '';...
            'Horz. Grid Node Spacing (m):' '' '' '' '' V.plotSettings.shiptracks.horizontal_grid_node_spacing;...
            'Vert. Grid Node Spacing (m):' '' '' '' '' V.plotSettings.shiptracks.vertical_grid_node_spacing;...
            '' '' '' '' '' '';...
            'SMOOTHED (SPATIALLY-AVERAGED) DATA PROPERTIES' '' '' '' '' '';...
            'Smoothed Planview:' '' '' '' '' '';...
            'Vector Spacing, in ground distance (m)' '' '' '' ''  num2str(V.plotSettings.planview.vector_spacing_plan_view*V.plotSettings.shiptracks.horizontal_grid_node_spacing);...
            'Vector Smoothing, in ground distance (m)' '' '' '' '' num2str(2*V.plotSettings.planview.smoothing_window_size*V.plotSettings.shiptracks.horizontal_grid_node_spacing);...
            '' '' '' '' '' '';...
            'DATA STRUCTURE' '' '' '' '' '';...
            ...
            '' '2. Other definitions: DAV = depth=-averaged velocity; WGS84 = World Geodetic System of 1984; dpthrng = depth range; Inf = infinity; m = meters; cm/s or cms = centimeters per second; deg. = degrees.' '' '' '' '';...
            '' '' '' '' '' '';...
            '' '' '' '' '' '';...
            'Form last revised:' '' V.release(2:end) '' '' '';...
            };
        ...
        for i = 1:length(dataFiles)
            ...
            load(fullfile(dataPath,dataFiles{i}))
            
            % Location, Time and Bathy
            ID = vertcat(ID,repmat(dataFiles(i),length(V.mcsX(1,:)),1));
            X = [X V.mcsX(1,:)];
            Y = [Y V.mcsY(1,:)];
            ...
            waitbar(i/(length(dataFiles)+1),hwait)
        end
    ...
    case 'Single'
        ...
        if poszsdvs < 0
            ...
            sout = {...
                ...
                'VMT version: ' V.version V.release '' '' '';...
                'Date Processed: ' datestr(now) '' '' '' '';...
                '' '' '' '' '' '';...
                'MEAN CROSS SECTION (MCS) PROPERTIES' '' '' '' '' '';...
                'Horz. Grid Node Spacing (m):' '' '' '' '' V.plotSettings.shiptracks.horizontal_grid_node_spacing;...
                ...
                'Horizontal Vector Spacing, in ground distance (m)' '' '' '' '' num2str(V.plotSettings.mcs.horizontal_vector_spacing*V.plotSettings.shiptracks.horizontal_grid_node_spacing);...
                'Horizontal Vector Smoothing, in ground distance (m)' '' '' '' '' num2str(2*V.plotSettings.mcs.horizontal_smoothing_window*V.plotSettings.shiptracks.horizontal_grid_node_spacing);...
                'Vertical Vector Spacing, in ground distance (m)' '' '' '' '' num2str(V.plotSettings.mcs.vertical_vector_spacing*V.plotSettings.shiptracks.vertical_grid_node_spacing);...
                'Vertical Vector Smoothing, in ground distance (m)' '' '' '' '' num2str(2*V.plotSettings.mcs.vertical_smoothing_window*V.plotSettings.shiptracks.vertical_grid_node_spacing);...
                '' '' '' '' '' '';...
                'FLOW ORIENTATION' '' '' '' '' '';...
